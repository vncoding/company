...
<div id="formsContent">
	<!-- Form container -->
	<form id="questionForm" class="form-horizontal" autocomplete="off" method="POST" action="">
	<legend><fmt:message key="domain.question.create.legend"/></legend>
		<div class="control-group">
			<label class="control-label" for="userName"><fmt:message key="domain.question.column.questionContent"/><em>*</em></label>
			<div class="controls">
				<input type="text" id="questionContent" name="questionContent" value="" maxlength="100" placeholder="QuestionContent">
		...
		<div class="form-actions">
			<button id="saveButton" type="submit" class="btn btn-primary"><fmt:message key="domain.operation.create"/> <fmt:message key="domain.question"/></button>
